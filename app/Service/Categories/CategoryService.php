...
class CategoryService
{
    ...
    {   
        $response=($id?Category::find($request->$id)->where('is_active',true)->first():Category::all()->where('is_active',true));
            return $this->returnData('Category',$response,'done'); 
    //     try{
    ...
    {
        $category=($id?Category::find($id):Category::all())->where('is_active',false);
