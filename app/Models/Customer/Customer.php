...
class Customer extends Model
{
    ...
    {
        return $query=Customer::join('customer_translation','customer_translation.customer_id','=','customer_id')
            ->where('customer_translation.local','=',get_current_local())
            ->select('customer.*','customer_translation.*')->get();
    }
